...
education: {
  ...
  bachelorsInstitution: 'University of Homs',
  bachelorsDescription: 'Completed my BSc in Software Engineering, focusing on full-stack development (React, Golang, Python) and developing practical projects in AI and Machine Learning',
